        ...
        <>
            ...
            <Container>
                ...
                <div className={`flexContainer ${styles.fileList}`}>
                    ...
                    <div>
                        <p>1. ¿Donde puedo consultar su aviso de privacidad integral?</p>
                    ...
                    <div>
                        ...
                        <p>Re: Para los aspirantes que aún no tienen título universitario ni cédula profesional debido a que se encuentran en trámite, podrán presentar su postulación presentando el acta de exámen profesional, debe presentar la constancia de terminación con los créditos al 100% y el certificado de calificaciones que expide la universidad que avala su formación. Dicho documento no es el cardex.</p>
                    </div>
                    <div>
                        <p>3. ¿Se pueden enviar los documentos por mensajería?</p>
                        <p>Re: Si, es posible enviarlos por mensajería, con la condición de que debe acordar su envío primero con la Sra. Juana García Chavez, quién es el responsable de este punto. Consultar el apartado Informes. Para enviarlos debe en todo momento respetar las fechas que indica la convocatoria y asegurarse que se entregue en las fechas indicadas. Por ningún motivo envíe documentos originales ya que pueden perderse o dañarse durante el envío.</p>
                    </div>
                    <div>
                        <p>4. Tengo problemas para inscribirme en linea para las especialidades pediatricas, finalizo el llenado de la solicitud con todos los datos requeridos, pero luego al enviar la información aparece una página donde se lee el siguiente mensaje: "Debe Leer los terminos del Aviso de Privacidad y marque la opción que aparece al principio del formulario".</p>
                    ...
                    <div>
                        <p>6. ¿Puedo envíar documentos por correo electrónico o fax?</p>
                        <p>Re: Por ningún motivo se reciben documentos escaneados, por correo electrónico ni vía fax.</p>
                    </div>
                    <div>
                        <p>7. ¿De que tamaño deben ser las fotocopias del título?</p>
                    ...
                    <div>
                        ...
                        <p>Re: Tiene casi tres meses para entregar su documentación, las entrevistas se le programarán en prioridad según el día que entregó documentos, los médicos extranjeros y los que vienen del interior de la república deben considerar esto ya que implicaría más dias de estancia. No hay cambios una vez asignada su entrevista. Si su documentación al ser validada esta incompleta o incorrecta, no tendra tiempo para corregirla y no recibimos documentación incompleta. Denos una buena impresión de usted, entregando todo a tiempo.</p>
                    </div>
                </div>
            </Container>
        </>
